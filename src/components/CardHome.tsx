...
function CardHome() {
  ...
  return (
    <>
      <div
        className="flex flex-col items-center sm:m-30 sm:p-5 justify-center bg-cover bg-center rounded-3xl shadow-2xl"
        style={{ backgroundImage: `url(${rogerioverso})` }}
      >
        ...
        <div className="flex flex-wrap items-center justify-center ">
          {collection.map((item, index) => (
            ...
            >
              <div className="max-w-xs sm:max-w-sm rounded-2xl overflow-hidden bg-white p-2 sm:p-6 sm:m-5 border border-gray-200 bg-white/30 backdrop-blur-md border border-white/20 shadow-2xl">
          ...
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.9, delay: 0.27 }}
          >
            <div className="max-w-xs sm:max-w-sm rounded-2xl overflow-hidden shadow-2xl bg-white p-2 sm:p-6 sm:m-10 border border-gray-200 bg-white/30 backdrop-blur-md border border-white/2">
              <h2 className="text-xl font-bold text-gray-800">
                <a className="h2-portfolio">Redes Sociais</a>
              </h2>
